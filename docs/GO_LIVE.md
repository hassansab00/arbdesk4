...
| # | File | What it does |
|---|---|---|
| 1 | `sql/ad4_00_preflight.sql` | **Run this first.** Guarantees every table, column and unique key the other 20 files need. |
...
| 21 | `sql/ad4_21_weather_features.sql` | **Run this last.** Morning conditions per city-day — dewpoint depression, cloud, wind, rain — plus the persistence benchmark every forecast must beat. |
