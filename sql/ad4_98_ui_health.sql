...
-- and function the app reads - 153 of them - and for each MISSING one names the
...
with expected(rel, owner, used_by) as (values
    ...
    ('archive_city_rollup', 'supabase/migrations/20260913091000_phase1d_databank_city_rollup.sql', ''),
    ('archive_daily_city_presence', 'supabase/migrations/20260912213000_phase1_data_foundation.sql', ''),
    ('archive_daily_rollup', 'supabase/migrations/20260912213000_phase1_data_foundation.sql', ''),
    ...
    ('paper_orders', 'supabase/migrations/20260912083705_paper_accounts_and_research_history.sql', ''),
    ('paper_position_settlements', 'supabase/migrations/20260912083740_paper_position_lifecycle.sql', ''),
    ('paper_positions', 'supabase/migrations/20260912083705_paper_accounts_and_research_history.sql', ''),
    ...
    ('v_opportunities', 'ad4_13_reconcile.sql', '(CityWatch), (Header), (ModelAnalytics), (SignalsPanel), /, /analytics, /board, /globe, /goals, /live, /monitor'),
    ('v_opportunity_context', 'ad4_22_opportunity_context.sql', '/opportunities'),
    ('v_outcome_evidence_health', 'supabase/migrations/20260913100000_phase2a_verified_outcome_truth.sql', '(DataBank), /synthesis'),
